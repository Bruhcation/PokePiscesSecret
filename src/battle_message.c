...
static const u8 sText_PkmnMadeItRain2[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_NAME_WITH_PREFIX}\nmade it rain!");
static const u8 sText_PkmnsXIntensifiedSun2[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_NAME_WITH_PREFIX}\nintensified the sun's rays!");
...
static const u8 sText_AbilityCoveredVeil[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} covered\n{B_ATK_TEAM2} team with a veil!");
static const u8 sText_AbilityIntensifiedGravity[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nintensified gravity!");
static const u8 sText_AbilityShieldedFromCriticalHits[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} shielded\n{B_ATK_TEAM2} team from critical hits\land super effective moves!");
...
static const u8 sText_PkmnsXInfatuatedY3[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY} made them\ninfatuated with {B_DEF_NAME_WITH_PREFIX}!");
