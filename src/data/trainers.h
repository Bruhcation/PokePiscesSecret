...
// OZONE LILYCOVE BRANCH
    ...
    [TRAINER_P_RAY_2] =
    {
        ...
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_WILL_SUICIDE | AI_FLAG_CHECK_VIABILITY | AI_FLAG_SETUP_FIRST_TURN | AI_FLAG_HP_AWARE | AI_FLAG_SMART_SWITCHING,
    ...
    [TRAINER_P_LANETTE] =
    {
        ...
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY | AI_FLAG_SCREENER | AI_FLAG_SETUP_FIRST_TURN | AI_FLAG_HP_AWARE | AI_FLAG_SMART_SWITCHING,
    ...
    [TRAINER_P_JACOBI] =
    {
        ...
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_TRY_TO_FAINT | AI_FLAG_WILL_SUICIDE,
