...
enum ItemSortType
{
    ...
    ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,
    ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
	ITEM_TYPE_FIELD_STATUS_BATTLE_ITEM,
    ITEM_TYPE_ORB_BATTLE_ITEM,
	ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
...
static const u16 sItemsByType[ITEMS_COUNT] =
{
	...
	[ITEM_FAVOR_SCARF] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_SHED_SHELL] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_BLUNDER_POLICY] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_FLOAT_STONE] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_SHELL_BELL] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_SILVER_POWDER] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_EJECT_BUTTON] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_EJECT_PACK] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_GRAVITY_CORE] = ITEM_TYPE_FIELD_STATUS_BATTLE_ITEM,
    [ITEM_HARD_STONE] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_GEMSTONE] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_SNOWBALL] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_NEVER_MELT_ICE] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_LOST_MANTLE] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_BINDING_BAND] = ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,
    [ITEM_CLEANSE_TAG] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_SPECTRAL_IDOL] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_SPELL_TAG] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_FOCUS_BAND] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_DESTINY_KNOT] = ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,
    [ITEM_DILATANT_MOD] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_SHELL_POLISH] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_BLACK_GLASSES] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_LUMINOUS_MOSS] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_ABSORB_BULB] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_UTILITY_UMBRELLA] = ITEM_TYPE_FIELD_STATUS_BATTLE_ITEM,
    [ITEM_TERU_CHARM] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_KAMEN_SCARF] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_TRIUMPH_STAR] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_FRIEND_RIBBON] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_CELL_BATTERY] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_FAIRY_RING] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_CRYPTIC_PLATE] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_CHARCOAL] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_BURNT_BRANCH] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_PESKY_PLUSH] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_QUICK_CLAW] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_BIG_ROOT] = ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,
    [ITEM_EERIE_MASK] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_SILVER_CROWN] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_CHUPACABRA] = ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,
    [ITEM_LONG_NOSE] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_MUSCLE_BAND] = ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,
    [ITEM_WISE_GLASSES] = ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,
    [ITEM_DRAGON_FANG] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_POISON_ORB] = ITEM_TYPE_ORB_BATTLE_ITEM,
    [ITEM_BLOOM_ORB] = ITEM_TYPE_ORB_BATTLE_ITEM,
    [ITEM_FLAME_ORB] = ITEM_TYPE_ORB_BATTLE_ITEM,
    [ITEM_PANIC_ORB] = ITEM_TYPE_ORB_BATTLE_ITEM,
    [ITEM_CURSED_AMULET] = ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,
    [ITEM_FROST_ORB] = ITEM_TYPE_ORB_BATTLE_ITEM,
    [ITEM_TOXIC_ORB] = ITEM_TYPE_ORB_BATTLE_ITEM,
    [ITEM_LIFE_ORB] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_ROOM_EXTENDER] = ITEM_TYPE_FIELD_STATUS_BATTLE_ITEM,
    [ITEM_VIBRANT_SCALE] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_AIR_BALLOON] = ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,
    [ITEM_ROCKY_HELMET] = ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,    
    [ITEM_KINGS_ROCK] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_FOCUS_SASH] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_TWISTED_SPOON] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_ZOOM_LENS] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_WIDE_LENS] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    ...
    [ITEM_ELECTRIC_SEED] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_GRASSY_SEED] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_MISTY_SEED] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_PSYCHIC_SEED] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_WHITE_HERB] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_MENTAL_HERB] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_POWER_HERB] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_MIRROR_HERB] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_IRON_BALL] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_LAGGING_TAIL] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_RING_TARGET] = ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,
    [ITEM_STICKY_BARB] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_GLUE_TUBE] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_BLACK_SALAD] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_MIRACLE_SEED] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_SCOPE_LENS] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_TERRAIN_EXTENDER] = ITEM_TYPE_FIELD_STATUS_BATTLE_ITEM,
    [ITEM_ASSAULT_VEST] = ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,
    [ITEM_POISON_BARB] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_SHARP_BEAK] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_PROTECTIVE_PADS] = ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,
    [ITEM_LIGHT_CLAY] = ITEM_TYPE_FIELD_STATUS_BATTLE_ITEM,
    [ITEM_HEAT_ROCK] = ITEM_TYPE_FIELD_STATUS_BATTLE_ITEM,
    [ITEM_SOFT_SAND] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_SAFETY_GOGGLES] = ITEM_TYPE_FIELD_STATUS_BATTLE_ITEM,
    [ITEM_STILETTO] = ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,
    [ITEM_DRIP_SHOES] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_CHOICE_BAND] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_CHOICE_SPECS] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_CHOICE_SCARF] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_BLACK_SLUDGE] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_METAL_COAT] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_BERSERK_GENE] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_LOADED_DICE] = ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,
    [ITEM_GUARD_SPEC] = ITEM_TYPE_BATTLE_ITEM,
    [ITEM_WINTAMEL_TEA] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_CHEESE] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_DOUGH_STICK] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_ICY_ROCK] = ITEM_TYPE_FIELD_STATUS_BATTLE_ITEM,
    [ITEM_YELLOW_SODA] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_MAGNET] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_FAMILY_MOSS] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_FAIRY_FEATHER] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_BRIGHT_POWDER] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_PUNCHING_GLOVE] = ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,
    [ITEM_RED_CARD] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_THROAT_SPRAY] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_SMOOTH_ROCK] = ITEM_TYPE_FIELD_STATUS_BATTLE_ITEM,
    [ITEM_CORRODE_MOD] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_METRONOME] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_BLACK_BELT] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_LEFTOVERS] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_MYSTIC_WATER] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_SILK_SCARF] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_EXPERT_BELT] = ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,
    [ITEM_DAMP_ROCK] = ITEM_TYPE_FIELD_STATUS_BATTLE_ITEM,
    [ITEM_WIDE_ARMOR] = ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,
    [ITEM_ODD_STONE] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_ADRENALINE_ORB] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_CLEAR_AMULET] = ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,
    [ITEM_COVERT_CLOAK] = ITEM_TYPE_MOVE_SPECIFIC_BATTLE_ITEM,
    [ITEM_COARSE_SAND] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_ABILITY_SHIELD] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_OBJECT_D_ARC] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_WEAKNESS_POLICY] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_FLIP_COIN] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
    [ITEM_HEART_GIFT] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_BATTLE_HELM] = ITEM_TYPE_OTHER_BATTLE_ITEM,
    [ITEM_DISTILL_MOD] = ITEM_TYPE_TYPE_ENHANCEMENT_BATTLE_ITEM,
    [ITEM_ZIG_SASH] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_KEYCHAIN] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_SOLAR_SWORD] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_MOON_MIRROR] = ITEM_TYPE_UNIQUE_POKEMON_BATTLE_ITEM,
    [ITEM_POKE_DOLL] = ITEM_TYPE_BATTLE_ITEM,
    [ITEM_FROTHY_CHEESE] = ITEM_TYPE_CONSUMABLE_BATTLE_ITEM,
